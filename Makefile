# This Makefile is for the Net::Rsh extension to perl.
#
...
#     NAME => q[Net::Rsh]
#     PREREQ_PM => { IO::Socket=>q[0], Errno=>q[0] }
#     VERSION_FROM => q[Rsh.pm]
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  Rsh.pm $(INST_MAN3DIR)/Net::Rsh.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Net/Rsh.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Net-Rsh' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Rsh.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Errno:                         0' >> META.yml
	$(NOECHO) $(ECHO) '    IO::Socket:                    0' >> META.yml
